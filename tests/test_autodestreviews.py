...
# def test_add_autodest_review_with_custom_reason2(app):
#     autodest_review = app.autodest_review(head=app.token_autorization(), autoDestId='5d655640e326d700012ad4d4',
#                                           rating=1,
#                                           review=random_string(250), fio=random_string(15), orderNum=None,
#                                           standardReasons=[],
#                                           customReason=random_custom_reason())
